...
const certs = [
  ...
  },
  {
    ...
    year:        "2024",
    icon:        "📱",
    image:       "/images/certs/google-flutter.jpg",
    issuerLogo:  "/images/issuers/google.png",
    issuerColor: "#4285F4",
    desc:        "Membangun aplikasi lintas platform (Android/iOS) menggunakan Flutter dan integrasi Firebase real-time.",
  ...
  {
    id: 3,
    name:        "Belajar Membuat Aplikasi Web",
    issuer:      "Dicoding Indonesia",
    issuerShort: "Dicoding",
    year:        "2024",
    icon:        "💻",
    image:       "/images/certs/dicoding-web.jpg",
    issuerLogo:  "/images/issuers/dicoding.png",
    issuerColor: "#38BDF8",
    desc:        "Penguasaan teknologi frontend modern: React, Tailwind CSS, dan integrasi REST API untuk aplikasi web responsif.",
