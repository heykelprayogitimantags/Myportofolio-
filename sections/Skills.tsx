...
import {
  ...
  SiGit, SiGithub, SiFigma, SiLinux, SiDocker,
} from "react-icons/si";
import { skillCategories, type Skill } from "@/data/skills";

// ── VS Code tidak ada di react-icons v5 — custom SVG ─────
const VscodeIcon = () => (
...
// ── Level config ──────────────────────────────────────────
const LEVEL_CFG = {
  Beginner:     { color: "#f59e0b", dots: 1 },
  Intermediate: { color: "#38BDF8", dots: 2 },
  Advanced:     { color: "#34d399", dots: 3 },
};
        ...
        <div className="flex items-center gap-3.5 mb-5">
          <div
            ...
            style={{
              ...
              fontSize:   "1.5rem",
              color:      hov ? iColor : "rgba(255,255,255,0.45)",
            }}
          >
            {icon}
          </div>
          ...
          <div className="flex-1 min-w-0">
            <p className="font-syne font-extrabold text-sm" style={{ color: "var(--text)" }}>
              {skill.name}
            </p>
            {/* Level dots */}
      ...
      <div className="max-w-[1160px] mx-auto px-6 relative z-10">
        ...
        >
          {[
            ...
            >
              <span className="font-syne font-extrabold text-2xl" style={{ color: s.color }}>{s.num}</span>
              <span className="text-[10px] font-bold uppercase tracking-wider font-syne mt-0.5" style={{ color: "var(--text3)" }}>{s.label}</span>
            </div>
          ))}
        </motion.div>
